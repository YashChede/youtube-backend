...
// front-end endpoint to refresh the access token
...
const changeCurrentPassword = asyncHandler(async (req, res) => {
  ...
  // pre hook only called when we save
  await user.save({ validateBeforeSave: false });
...
// always try to keep file updates in seperate controller
// as we have to again need to save text data
